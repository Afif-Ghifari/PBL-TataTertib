...
<body class="flex">
    ...
    <main class="w-full h-screen bg-slate-200 ml-72">
        ...
        <section class="flex flex-col h-fit bg-slate-100 w-full px-14 py-12 gap-10">
            <h1 class="text-3xl">Tambah Data Dosen</h1>

            <form action="../../backend/tambahDataDosen.php" method="POST" class="flex flex-col h-full justify-between">
                <label for="NIP" class="flex flex-col gap-2 my-2">
                    NIP
                    <input type="text" value="" class="border py-2 px-4 rounded-xl form-control" placeholder="Masukkan NIP" name="NIP">
                </label>
                ...
                <input type="text" class="hidden" value=" " placeholder="Masukkan Username" name="Profil" required>
                <div class="flex justify-between my-6 gap-6">
